...
answers through Gradescope by 11pm on Sunday, September 25th.
...
Please complete the following steps to calculate main observed statistic of
...
by subtracting the `null_white_rates` from the `null_black_rates` and save this
...
to a p-value by dividing by the total number of simulations (remember that this 
might be a different kind of p-value than what you have worked with in the 
past). Describe whether this p-value provides sufficient evidence that resumes 
with names generally perceived as White receive callbacks at a higher rate 
than resumes with names generally perceived as Black.
...
actually have a higher price than the ideal cut diamond! This is strange since
...
3](https://yale.instructure.com/courses/79947/quizzes/52426)
