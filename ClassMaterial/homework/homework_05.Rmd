...
4. It should contain a text annotation at position (1910, 500) that it blue text says "Stephans still alive". The annotation text should be aligned to the left. 

5. It should contain a text annotation at position (1910, 550) that it red text says "Total Stephans born".This annotation text should also be aligned to the left.  
