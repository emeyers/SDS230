...
Recreate your bar plot and pie chart to only show countries that have at least 150 bands originating from them. Also see if you can create a better color scheme for the pie chart. Hint: To figure out how to change the color of the pie chart, using `? pie` could be helpful. You might find it useful to look at [this list of color names](http://www.stat.columbia.edu/~tzheng/files/Rcolor.pdf).
...
Please reflect on how the homework went by going to Canvas, going to the Quizzes link, and clicking on [Reflection on homework 1](https://yale.instructure.com/courses/79947/quizzes/52447)
