...
To explore the dplyr functions, we will use data that consists of random sample of movies that were scraped from the [Rotten Tomatoes](https://www.rottentomatoes.com/) and [IMDB](https://www.imdb.com/) websites. A code book describing the variables in this data frame and be found on [this website](http://www2.stat.duke.edu/~mc301/data/movies.html).
